    ...
    line_items: [
      {
        ...
        description:
          "These are non-refundable tickets to this years 2020 TEDxDesignTechHS event. These tickets will be sent to the address that you provided as your shipping address.",
        amount: price,
        currency: "usd",
        quantity: 1
      }
