...
$(function () {
  ...
  var addCartInfo = function addCartInfo() {
    ...
    $('.cart-info-widget .subtotal-wrap .charge').text(price.subTotal === 0 ? "Free" : "$".concat(price.subTotal.toFixed(2)));
    $('.cart-info-widget .fees-wrap .charge').text(price.fee === 0 ? "Free" : "$".concat(price.fee.toFixed(2)));
    $('.cart-info-widget .total-price').text(price.total === 0 ? "Free" : "$".concat(price.total.toFixed(2)));
  };
